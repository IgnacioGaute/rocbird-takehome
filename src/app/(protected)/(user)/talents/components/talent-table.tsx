...
interface DataTableProps<TData, TValue> {
  columns: (referentes: ReferenteTecnico[]) =>  ColumnDef<TData, TValue>[];
  data: TData[];
  referentes: ReferenteTecnico[];
}

export function TalentoTable<TData, TValue>({
  columns,
  data,
  referentes
         ...
         <div className="flex-1 max-w-md">
           <div className="relative">
             ...
             <Input
               ...
               className="pl-10 h-11 bg-slate-800/90 border-slate-600 text-white placeholder:text-slate-300 focus:border-blue-400 focus:ring-blue-400/20 rounded-xl transition-all duration-200"
             />
           </div>
         </div>
        
        <div className="flex items-center gap-3">
          <CreateTalentDialog referentes={referentes}/>
          <div className="relative">
                ...
                <TableRow>
                   ...
                   >
                     <div className="flex flex-col items-center gap-2">
                       ...
                       <p className="text-sm font-medium text-slate-200">No hay talentos para mostrar</p>
                       <p className="text-xs text-slate-400">Comienza agregando un nuevo talento</p>
                     </div>
                   </TableCell>
                </TableRow>
              )}
